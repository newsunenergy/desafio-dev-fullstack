    ...
    <div className={container()}>
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button
            className="text-sm font-semibold text-error-700 hover:text-red-900 dark:text-error-400 dark:hover:text-error-300"
            type="button"
          >
            Tente novamente
          </button>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100">
              <div
                className="h-2 rounded-full bg-newSun-gold"
                style={{
      ...
      {state === 'complete' ? (
        <CheckCircle2 className="h-5 w-5 fill-newSun-gold text-white" />
      ) : (
