...
const Listing = () => {
  ...
  return (
    <div className="mt-28 w-[900px] h-[600px] bg-box rounded-lg border border-textInput overflow-auto">
      <FilterSimulation filterValue={filterLeads} setFilterValue={handleFilterChange} />
